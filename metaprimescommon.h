...
template<uint_t PrimeCandidate>
struct CheckNone
{
...
template<template<uint_t> class InitCheck = CheckSmallPrimes2_5>
struct IsPrime6
{
  template<uint_t PrimeCandidate>
  struct Do {
...
template<template<uint_t> class InitCheck = CheckSmallPrimes2_29>
struct IsPrime30
{
  template<uint_t PrimeCandidate>
  struct Do {
