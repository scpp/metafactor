...
template<uint_t Q, typename List, uint_t N>
struct FilterRemindersList;

template<uint_t Q, typename H, typename Tail, uint_t N>
...
{
  static const uint_t value = T::Head::value;
};
...
{
  static const uint_t NextQ = Q*RList::Head::value;
